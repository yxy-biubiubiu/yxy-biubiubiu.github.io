...
path = '/data/home/zenggang/yxy/simulations-cam5/forcedata/'
yearhigh = np.array([1987,1988,1996,1999,2010,2011])
yearlow = np.array([1986,1992,2003,2004,2005,2016])
month = np.array([12,1,2])
period = 32
latrange = np.array([75,80])
lonrange = np.array([20,55])
forcing_change(path,period,month,yearhigh,yearlow,latrange,lonrange,'sst')